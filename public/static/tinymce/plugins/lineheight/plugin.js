;(function(tinymce) {
  tinymce.PluginManager.add('lineheight', function(editor, url, $) {
    ...
    editor.addButton('lineheightselect', function() {
      var items = [], 
        defaultLineHeightFormats = '8px 10px 12px 14px 16px 18px 24px 36px 42px 48px 72px'
      var lineheight_formats =
        editor.settings.lineheight_formats || defaultLineHeightFormats
  ...
  tinymce.PluginManager.requireLangPack('lineheight', 'zh_CN')
})(tinymce)
