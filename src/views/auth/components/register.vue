    ...
    >
      ...
      <el-form-item prop="phone">
        <div class="item-content">
          <span class="__label-tit"> {{ $t('auth.register.phone') }} </span>
          <el-input
            ref="phone"
            v-model="form.phone"
            :maxlength="11"
            :placeholder="$t('auth.register.phoneMsg')"
            type="tel"
            auto-complete="off"
          />
        </div>
      ...
      <el-form-item prop="code">
        <div class="item-content">
          <span class="__label-tit"> {{ $t('auth.register.code') }} </span>
          <el-input
            ref="code"
            v-model="form.code"
            :maxlength="6"
            :placeholder="$t('auth.register.codeMsg')"
            style="width: 150px"
          />
          <verification-code
            :mobile="form.phone"
      ...
      <el-form-item prop="password">
        <div class="item-content">
          <span class="__label-tit">
            {{ $t('auth.register.newPassword') }}
          </span>
          <el-input
            v-model="form.password"
            :minlength="6"
            :maxlength="20"
            :placeholder="$t('auth.register.newPasswordMsg')"
            :type="pType"
      ...
      <el-form-item prop="rePassword">
        <div class="item-content">
          ...
          <el-input
            ...
            :minlength="6"
            :maxlength="20"
            :placeholder="$t('auth.register.confirmPasswordMsg')"
...
import { register, getHash } from '@/api/auth'

import { passwordEncrypt } from '@/utils/encrypt'

import { deepClone } from '@/utils'

import rules from '@/validate/auth/register'
...
const { SU_REGISTER, ER_PASSWORD_DIFF } = configPrompt
